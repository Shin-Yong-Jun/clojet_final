          ...
          <div className="footer_top">
            ...
            <div className="footer_icon">
              <ul>
                <li>
                  <a href="/">
                    <img src={require("../image/f-icon.png")} alt="페이스북" />
                  </a>
                </li>
                <li>
                  <a href="/">
                    <img src={require("../image/i-icon.png")} alt="인스타그램" />
                  </a>
                </li>
                <li>
                  <a href="/">
                    <img src={require("../image/y-icon.png")} alt="유튜브" />
                  </a>
                </li>
              </ul>
            </div>
          ...
          <div className="footer_bottom">
            <div className="b_left">
              ...
              <div className="info">
                ...
                <br />
                <span>
                  주소 : 경기도 성남시 분당구 돌마로 46 5층 그린컴퓨터아카데미
                  성남분당점
                </span>
                <br />
                ...
                <p>
                  copyright&#x24D2; 2021 MANDARINA DUCK. all rights reserved.
                  hosting by
                  &#xC5D4;&#xC5D0;&#xC774;&#xCE58;&#xC5D4;&#xCEE4;&#xBA38;&#xC2A4;(&#xC8FC;).
                  design by &#xB514;&#xC790;&#xC778;&#xC704;&#xBE0C;.
                </p>
