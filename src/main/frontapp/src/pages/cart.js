              ...
              <TableRow>
                <TableCell align="left" className="chkhd">
                  <input
                    ...
                    checked={
                      checkedRows.length === EditCartData.length &&
              ...
              {EditCartData.map((row, index) => (
                <TableRow key={row.iteminfo}>
                  ...
                  <TableCell align="center" className="tableCell">
                    <Link to={row.detailUrl}>{row.iteminfo}</Link>
                  </TableCell>
                  <TableCell align="center" className="tableCell">
                    {row.color}
                  </TableCell>
                  <TableCell align="center" className="tableCell">
                    <Link to={row.detailUrl}>{row.size}</Link>
                  </TableCell>
  ...
  function SumCart({ data, checkedRows }) {
    ...
    return (
      <>
        ...
        <button onClick={() => setRedirect(purchaseChk())} className="purchase">
          결제하기
        </button>
